/**
 * ================================================================
 * [초보자용 상세 주석] 07-03 가로 트리 자동 배치
 * ================================================================
 *
 * 이 파일에서 만드는 것
 * - TreeLayout 방향을 왼쪽에서 오른쪽으로 설정합니다.
 * - 예상 결과: 노드 4개, 연결선 3개
 ...
 * - LeftToRight: 이번 예제에서 LeftToRight 기능을 설정하거나 실행하기 위해 사용하는 API·속성입니다.
 *
 * 기억할 점
...
new Rect(0, 0, 48, 26); n.text = text; n.expandable = expandable; n.expanded = expandable; model.addItem(n); return n; };
    const root = make("왼쪽 루트", true); ["분기 A", "분기 B", "분기 C"].forEach((text) => model.factory./* [연결선 생성] 출발 노드와 도착 노드가 Diagram에 준비된 뒤 두 노드를 연결합니다. */
createDiagramLink(root, make(text))); const layout = new TreeLayout(); layout.direction = LayoutDirection.LeftToRight; layout.levelDistance = 34; layout.nodeDistance = 22; model.arrange(layout); return model;
  });
