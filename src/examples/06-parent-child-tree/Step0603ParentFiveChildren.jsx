/**
 * ================================================================
 * [초보자용 상세 주석] 06-03 부모 1개와 자식 5개
 * ================================================================
 *
 * 이 파일에서 만드는 것
 * - 반복문으로 부모에 다섯 자식을 연결합니다.
 * - 예상 결과: 노드 6개, 연결선 5개
...
new Rect(x, y, 42, 26); n.text = text; n.expandable = expandable; n.expanded = expandable; model.addItem(n); return n; };
    const root = make("부모", 104, 15, true); for (let i = 0; i < 5; i += 1) model.factory./* [연결선 생성] 출발 노드와 도착 노드가 Diagram에 준비된 뒤 두 노드를 연결합니다. */
createDiagramLink(root, make(`자식 ${i + 1}`, 8 + i * 52, 92)); return model;
  });
