/**
 * ================================================================
 * [초보자용 상세 주석] 03-04 텍스트 자르기 비교
 * ================================================================
 *
 * 이 파일에서 만드는 것
 * - clipText 적용 여부에 따른 긴 텍스트 표시를 비교합니다.
 * - 예상 결과: 노드 2개, 연결선 0개
 ...
 *
 * 이번 예제의 핵심 용어
 * - clipText: 이번 예제에서 clipText 기능을 설정하거나 실행하기 위해 사용하는 API·속성입니다.
...
new Rect(x, 35, 65, 36); node.text = text; node.clipText = clipText; node.brush = "#fff4dc"; node.stroke = "#d98719";
      model.addItem(node);
    });
    return model;
  });
