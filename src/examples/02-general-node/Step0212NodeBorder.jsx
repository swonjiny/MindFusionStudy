/**
 * ================================================================
 * [초보자용 상세 주석] 02-12 노드 테두리
 * ================================================================
 *
 * 이 파일에서 만드는 것
 * - stroke, 굵기, 선 모양을 비교합니다.
 * - 예상 결과: 노드 3개, 연결선 0개
...
new Rect(x, 40, 44, 28); node.text = text; node.brush = "#eef6ff"; node.stroke = "#2877de"; node.strokeThickness = thickness; node.strokeDashStyle = dash;
      model.addItem(node);
    });
    return model;
  });
