/**
 * [프로젝트 구조 안내] 사이트의 모든 메뉴 이름, 설명, 예상 노드·연결선 수를 관리하는 원본 데이터입니다.
 * readySpecs 한 행이 하나의 학습 메뉴가 되고, 아래 변환 과정에서 category와 이전·다음 key가 계산됩니다.
 * 새 메뉴를 추가할 때 배열 순서가 곧 학습 순서이므로 key, 가이드 경로, 예제 등록을 함께 확인합니다.
 */
const readySpecs = [
