 ...
 * - createDiagramLink: 이번 예제에서 createDiagramLink 기능을 설정하거나 실행하기 위해 사용하는 API·속성입니다.
 *
 * 기억할 점
...
new Rect(20, 38, 48, 30); start.text = "시작"; model.addItem(start);
...
createDiagramLink(start, end); link.stroke = "#4e6b95"; link.strokeThickness = 2;
    return model;
  });
