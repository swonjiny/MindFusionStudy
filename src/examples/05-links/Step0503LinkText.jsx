/**
 * ================================================================
 * [초보자용 상세 주석] 05-03 연결선 텍스트 표시
 * ================================================================
 *
 * 이 파일에서 만드는 것
 * - 연결선의 text 속성에 관계 설명을 표시합니다.
 * - 예상 결과: 노드 2개, 연결선 1개
 ...
 * - text: 이번 예제에서 text 기능을 설정하거나 실행하기 위해 사용하는 API·속성입니다.
 *
 * 기억할 점
...
new Diagram();
    const order = /* [일반 노드 생성] ShapeNode 객체만 만든 상태이며, bounds·text·스타일을 설정한 뒤 Diagram에 등록해야 화면에 나타납니다. */
new ShapeNode(model); order.bounds = /* [위치와 크기] Rect(x, y, width, height)로 다이어그램 좌표상의 위치와 노드 크기를 함께 지정합니다. */
new Rect(18, 38, 52, 30); order.text = "주문"; model.addItem(order);
...
createDiagramLink(order, payment); link.text = "승인 요청"; link.stroke = "#2877de"; link.strokeThickness = 2;
    return model;
  });
