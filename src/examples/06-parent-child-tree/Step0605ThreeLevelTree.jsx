/**
 * ================================================================
 * [초보자용 상세 주석] 06-05 3단계 트리 구성
 * ================================================================
 *
 * 이 파일에서 만드는 것
 * - 루트·중간 노드·리프의 3단계 트리를 완성합니다.
 * - 예상 결과: 노드 7개, 연결선 6개
 ...
 *
 * 이번 예제의 핵심 용어
 * - expandable: 이번 예제에서 expandable 기능을 설정하거나 실행하기 위해 사용하는 API·속성입니다.
...
new Rect(x, y, 48, 24); n.text = text; n.expandable = expandable; n.expanded = expandable; model.addItem(n); return n; }; const link = (a, b) => model.factory./* [연결선 생성] 출발 노드와 도착 노드가 Diagram에 준비된 뒤 두 노드를 연결합니다. */
createDiagramLink(a, b);
