/**
 * ================================================================
 * [초보자용 상세 주석] 01-03 Diagram 배경 설정
 * ================================================================
 *
 * 이 파일에서 만드는 것
 * - Diagram 배경과 격자를 표시합니다.
 * - 예상 결과: 노드 0개, 연결선 0개
 ...
 * - backBrush: 이번 예제에서 backBrush 기능을 설정하거나 실행하기 위해 사용하는 API·속성입니다.
 *
 * 기억할 점
 ...
 * - 렌더링할 때마다 new Diagram()을 호출하면 기존 노드와 선택 상태가 사라질 수 있습니다.
 */
