/**
 * ================================================================
 * [초보자용 상세 주석] 13-04 카드 수 기반 크기 계산
 * ================================================================
 *
 * 이 파일에서 만드는 것
 * - 카드 수로 노드 너비와 높이를 계산한 뒤 선택 시 적용합니다.
 * - 예상 결과: 노드 1개, 연결선 0개
...
new Diagram()); const viewRef = useRef(null); const initialized = useRef(false); const nodeRef = useRef(null); const [expanded, setExpanded] = useState(false); const events = useRef(0); const size = sizeFor(cards.length);
