/**
 * ================================================================
 * [초보자용 상세 주석] 03-03 텍스트 외곽선
 * ================================================================
 *
 * 이 파일에서 만드는 것
 * - textStroke와 textStrokeThickness를 적용합니다.
 * - 예상 결과: 노드 2개, 연결선 0개
 ...
 *
 * 이번 예제의 핵심 용어
 * - textStroke: 이번 예제에서 textStroke 기능을 설정하거나 실행하기 위해 사용하는 API·속성입니다.
 * - textStrokeThickness: 이번 예제에서 textStrokeThickness 기능을 설정하거나 실행하기 위해 사용하는 API·속성입니다.
 *
 * 기억할 점
...
new Diagram();
    const plain = /* [일반 노드 생성] ShapeNode 객체만 만든 상태이며, bounds·text·스타일을 설정한 뒤 Diagram에 등록해야 화면에 나타납니다. */
new ShapeNode(model);
    plain.bounds = /* [위치와 크기] Rect(x, y, width, height)로 다이어그램 좌표상의 위치와 노드 크기를 함께 지정합니다. */
new Rect(22, 36, 62, 34); plain.text = "기본 텍스트"; plain.fontSize = 14; plain.brush = "#eef6ff"; plain.stroke = "#2877de";
    model.addItem(plain);
