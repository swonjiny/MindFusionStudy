 ...
 * 3. variant="18-03" 값이 현재 학습 단계를 지정합니다.
...
export default function Step1803AutomaticVerification(props) { return <IntegratedDiagramExample {...props} variant="verification" />; }
