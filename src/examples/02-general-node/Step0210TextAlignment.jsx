 ...
 *
 * 이번 예제의 핵심 용어
 * - Alignment: 이번 예제에서 Alignment 기능을 설정하거나 실행하기 위해 사용하는 API·속성입니다.
...
new Rect(x, 34, 45, 38); node.text = text; node.textAlignment = alignment; node.lineAlignment = alignment; node.brush = "#e8f3ff"; node.stroke = "#2877de";
      model.addItem(node);
    });
    return model;
  });
