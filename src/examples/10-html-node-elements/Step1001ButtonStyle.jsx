/**
 * ================================================================
 * [초보자용 상세 주석] 10-01 HTML 버튼 모양
 * ================================================================
 *
 * 이 파일에서 만드는 것
 * - ControlNode 안에 data-interactive 버튼의 모양을 만듭니다.
 * - 예상 결과: 노드 1개, 연결선 0개
 ...
 *
 * 이번 예제의 핵심 용어
 * - button: 이번 예제에서 button 기능을 설정하거나 실행하기 위해 사용하는 API·속성입니다.
...
const domCreated = (_sender, args) => { const root = args.node.getContent(); report(root.querySelectorAll('[data-mf-html-node="10-01"]').length, root.querySelectorAll('button').length); };
  ...
  return <div data-testid="diagram-demo"><p>아직 이벤트를 연결하지 않고 HTML 버튼의 모양만 만듭니다.</p><div style={{ height: 460 }}>/* [화면 렌더링] 준비한 Diagram 모델과 ref, 이벤트 함수를 DiagramView prop으로 전달합니다. 부모 요소에는 반드시 높이가 있어야 합니다. */
