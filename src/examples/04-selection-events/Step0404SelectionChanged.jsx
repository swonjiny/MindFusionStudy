/**
 * ================================================================
 * [초보자용 상세 주석] 04-04 선택 변경 이벤트
 * ================================================================
 *
 * 이 파일에서 만드는 것
 * - onSelectionChanged에서 이전·새 선택 항목을 확인합니다.
 * - 예상 결과: 노드 3개, 연결선 0개
 ...
 * - SelectionChangedEventArgs: 이번 예제에서 SelectionChangedEventArgs 기능을 설정하거나 실행하기 위해 사용하는 API·속성입니다.
 *
 * 기억할 점
