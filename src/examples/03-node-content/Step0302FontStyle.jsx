/**
 * ================================================================
 * [초보자용 상세 주석] 03-02 글꼴 스타일 설정
 * ================================================================
 *
 * 이 파일에서 만드는 것
 * - Font 객체로 글꼴 크기와 굵기를 설정합니다.
 * - 예상 결과: 노드 2개, 연결선 0개
 ...
 *
 * 이번 예제의 핵심 용어
 * - Font: 이번 예제에서 Font 기능을 설정하거나 실행하기 위해 사용하는 API·속성입니다.
...
new Rect(x, 36, 62, 34); node.text = text; node.font = font; node.brush = "#e8f8ef"; node.stroke = "#289766";
      model.addItem(node);
    });
    return model;
  });
