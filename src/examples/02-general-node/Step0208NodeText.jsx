/**
 * ================================================================
 * [초보자용 상세 주석] 02-08 노드 텍스트 표시
 * ================================================================
 *
 * 이 파일에서 만드는 것
 * - 노드의 text와 글자 스타일을 설정합니다.
 * - 예상 결과: 노드 1개, 연결선 0개
...
new Rect(48, 38, 68, 32); node.text = "한글 텍스트"; node.textColor = "#1456b8"; node.fontSize = 14; node.brush = "#eef6ff"; node.stroke = "#2877de";
    model.addItem(node);
    return model;
  });
