/**
 * ================================================================
 * [초보자용 상세 주석] 02-07 노드 크기 변경
 * ================================================================
 *
 * 이 파일에서 만드는 것
 * - bounds의 너비와 높이를 변경합니다.
 * - 예상 결과: 노드 1개, 연결선 0개
...
new Rect(50, 40, 55, 28); node.text = "크기 변경"; node.brush = "#e8f3ff"; node.stroke = "#2877de";
    model.addItem(node);
    return model;
  });
  ...
  return <div data-testid="diagram-demo"><button onClick={resize}>노드 크게 만들기</button><div style={{ height: 460 }}>/* [화면 렌더링] 준비한 Diagram 모델과 ref, 이벤트 함수를 DiagramView prop으로 전달합니다. 부모 요소에는 반드시 높이가 있어야 합니다. */
