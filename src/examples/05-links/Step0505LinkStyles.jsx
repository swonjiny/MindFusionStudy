/**
 * ================================================================
 * [초보자용 상세 주석] 05-05 연결선 모양과 스타일 비교
 * ================================================================
 *
 * 이 파일에서 만드는 것
 * - Bezier와 Cascading 연결선, 색상과 점선을 비교합니다.
 * - 예상 결과: 노드 3개, 연결선 2개
 ...
 *
 * 이번 예제의 핵심 용어
 * - LinkShape: 이번 예제에서 LinkShape 기능을 설정하거나 실행하기 위해 사용하는 API·속성입니다.
 * - DashStyle: 이번 예제에서 DashStyle 기능을 설정하거나 실행하기 위해 사용하는 API·속성입니다.
 *
 * 기억할 점
...
new Rect(x, y, 45, 28); node.text = text; model.addItem(node); return node;
    });
    const curve = model.factory./* [연결선 생성] 출발 노드와 도착 노드가 Diagram에 준비된 뒤 두 노드를 연결합니다. */
createDiagramLink(nodes[0], nodes[1]); curve.text = "Bezier"; curve.shape = LinkShape.Bezier; curve.stroke = "#2877de";
