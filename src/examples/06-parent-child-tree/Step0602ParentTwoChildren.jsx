/**
 * ================================================================
 * [초보자용 상세 주석] 06-02 부모 1개와 자식 2개
 * ================================================================
 *
 * 이 파일에서 만드는 것
 * - 하나의 부모에서 두 자식으로 분기하는 구조를 만듭니다.
 * - 예상 결과: 노드 3개, 연결선 2개
...
new Rect(x, y, 52, 28); n.text = text; n.expandable = expandable; n.expanded = expandable; model.addItem(n); return n; };
    const root = make("부모", 82, 18, true); [make("자식 1", 30, 92), make("자식 2", 134, 92)].forEach((child) => model.factory./* [연결선 생성] 출발 노드와 도착 노드가 Diagram에 준비된 뒤 두 노드를 연결합니다. */
createDiagramLink(root, child)); return model;
  });
