/**
 * ================================================================
 * [초보자용 상세 주석] 02-06 노드 위치 변경
 * ================================================================
 *
 * 이 파일에서 만드는 것
 * - bounds를 갱신해 노드 위치를 변경합니다.
 * - 예상 결과: 노드 1개, 연결선 0개
...
new Rect(38, 34, 55, 28); node.text = "위치 변경"; node.brush = "#e8f3ff"; node.stroke = "#2877de";
    model.addItem(node);
    return model;
  });
  ...
  return <div data-testid="diagram-demo"><button onClick={move}>오른쪽 아래로 이동</button><div style={{ height: 460 }}>/* [화면 렌더링] 준비한 Diagram 모델과 ref, 이벤트 함수를 DiagramView prop으로 전달합니다. 부모 요소에는 반드시 높이가 있어야 합니다. */
