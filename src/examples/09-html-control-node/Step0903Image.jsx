/**
 * ================================================================
 * [초보자용 상세 주석] 09-03 HTML 이미지 표시
 * ================================================================
 *
 * 이 파일에서 만드는 것
 * - ControlNode 안에 복사 가능한 data URI 이미지를 표시합니다.
 * - 예상 결과: 노드 1개, 연결선 0개
 ...
 * - data URI: 이번 예제에서 data URI 기능을 설정하거나 실행하기 위해 사용하는 API·속성입니다.
 *
 * 기억할 점
...
const domCreated = (_sender, args) => report(args.node.getContent().querySelectorAll('[data-mf-html-node="09-03"] img').length);
  ...
  return <div data-testid="diagram-demo"><p>외부 파일 없이 복사 가능한 data URI 이미지를 표시합니다.</p><div style={{ height: 460 }}>/* [화면 렌더링] 준비한 Diagram 모델과 ref, 이벤트 함수를 DiagramView prop으로 전달합니다. 부모 요소에는 반드시 높이가 있어야 합니다. */
