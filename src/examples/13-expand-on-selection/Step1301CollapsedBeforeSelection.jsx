/**
 * ================================================================
 * [초보자용 상세 주석] 13-01 선택 전 축약 상태
 * ================================================================
 *
 * 이 파일에서 만드는 것
 * - 선택되지 않은 노드는 카드 목록을 숨기고 축약 상태로 표시합니다.
 * - 예상 결과: 노드 1개, 연결선 0개
 ...
 * - collapsed template: 이번 예제에서 collapsed template 기능을 설정하거나 실행하기 위해 사용하는 API·속성입니다.
...
const domCreated = () => report();
  ...
  return <div data-testid="diagram-demo"><p data-testid="expand-state">선택 0개 · 축약 상태 · 카드 DOM 0개</p><div style={{ height: 460 }}>/* [화면 렌더링] 준비한 Diagram 모델과 ref, 이벤트 함수를 DiagramView prop으로 전달합니다. 부모 요소에는 반드시 높이가 있어야 합니다. */
