/**
 * ================================================================
 * [초보자용 상세 주석] 03-01 텍스트 여백 설정
 * ================================================================
 *
 * 이 파일에서 만드는 것
 * - Thickness로 노드 안쪽 텍스트 여백을 설정합니다.
 * - 예상 결과: 노드 2개, 연결선 0개
 ...
 *
 * 이번 예제의 핵심 용어
 * - Thickness: 이번 예제에서 Thickness 기능을 설정하거나 실행하기 위해 사용하는 API·속성입니다.
 * - textPadding: 이번 예제에서 textPadding 기능을 설정하거나 실행하기 위해 사용하는 API·속성입니다.
 *
 * 기억할 점
...
new Rect(x, 35, 60, 38); node.text = text; node.textPadding = padding;
