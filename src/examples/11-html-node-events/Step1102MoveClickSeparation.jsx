/**
 * ================================================================
 * [초보자용 상세 주석] 11-02 노드 이동과 버튼 클릭 분리
 * ================================================================
 *
 * 이 파일에서 만드는 것
 * - 노드 영역 드래그와 내부 버튼 클릭 입력을 분리합니다.
 * - 예상 결과: 노드 1개, 연결선 0개
 ...
 * - stopPropagation: 이번 예제에서 stopPropagation 기능을 설정하거나 실행하기 위해 사용하는 API·속성입니다.
...
new Diagram()); const viewRef = useRef(null); const initialized = useRef(false); const cleanupRef = useRef(() => {}); const [message, setMessage] = useState("버튼 클릭 대기 중");
